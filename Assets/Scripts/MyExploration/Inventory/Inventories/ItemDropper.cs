...
namespace MyExploration.Inventories
{
    ...
    public class ItemDropper : MonoBehaviour, ISaveable
    {
        ...
        /// </summary>
        /// <param name="item">The item type for the pickup.</param>
        public void DropItemAtHand(InventoryItem item, int number)
        {
            EquipPickup(item, GetEquipLocation(), number);
        }
        ...
        {
            return PlayerExaminationData.Instance.ExaminingPlace.position;
        }

        private Vector3 GetEquipLocation()
        {
            return PlayerInteractionData.Instance.HoldingAnchor.position;
        }
        ...
        void EquipPickup(InventoryItem item, Vector3 spawnLocation, int number)
        {
            var pickup = item.SpawnPickup(spawnLocation, number);
            pickup.HoldIt();
            droppedItems.Add(pickup);
        ...
        object ISaveable.CaptureState()
        {
            ...
            for (int i = 0; i < droppedItemsList.Length; i++)
            {
                ...
                droppedItemsList[i].number = droppedItems[i].GetQuantity();
            }
