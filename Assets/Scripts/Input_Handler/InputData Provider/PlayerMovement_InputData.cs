...
public class PlayerMovement_InputData 
{
    private static PlayerMovement_InputData m_Instance = new PlayerMovement_InputData();
    public static PlayerMovement_InputData Instance { get { return m_Instance; } }
    ...
    {
        get => m_shootPressed;
        set => m_shootPressed = value;
    }

    public bool ConsumePressed
    {
        get => m_consumePressed;
        set => m_consumePressed = value;
    }
    #endregion
